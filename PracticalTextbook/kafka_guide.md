...
Kafka 클러스터 구축부터 메시지 송수신, Nginx 로그 데이터 수집 및 Object Storage 저장까지의 전체 흐름을 실습합니다. 이를 통해 Kafka의 기본 개념과 활용 방식, 실시간 로그 처리 및 데이터 적재 기법을 익힐 수 있습니다.
...
2. **Kafka 클러스터 생성**
    ...
    - **클러스터 설정**
        - **클러스터 이름:** 예를 들어, `kafka-cluster`로 지정합니다.
