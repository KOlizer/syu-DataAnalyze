...
export PROJECT_ID="86099dec56044a43ac3f92a40784929b"
export TOPIC_NAME="Test-Topic-lsh"
export TOPIC_NAME_MK="Create-Topic-lsh"
export TOPIC_DESCRIPTION=""
export TOPIC_RETENTION_DURATION="600s"
export SUB_NAME="PullSubscription"
...
export SUBSCRIPTION_NAME="PullSubscription"
export OBJECT_STORAGE_SUBSCRIPTION_NAME="CreateSub"
export OBJECT_STORAGE_BUCKET="objectstorage-lsh"
