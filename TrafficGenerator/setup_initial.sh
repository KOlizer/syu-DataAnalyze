...
# 환경 변수 정의 (필요한 변수만 포함)
export PUBSUB_ENDPOINT="[https://pub-sub.kr-central-2.kakaocloud.com](https://pub-sub.kr-central-2.kakaocloud.com/)"
...
export OBJECT_STORAGE_SUBSCRIPTION_NAME_MK="{실습용 서브스크립션 이름(objectstoragesubscription)}"
